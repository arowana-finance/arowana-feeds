...
export interface ARWFeedInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "initializeARWFeedInfo",
    values: [
      AddressLike,
      AddressLike,
      string,
  ...
  encodeFunctionData(
    functionFragment: "initializeConsumer",
...
export namespace InitializedConsumerEvent {
...
export interface ARWFeed extends BaseContract {
  ...
  initializeConsumer: TypedContractMethod<
    [_initOwner: AddressLike, _router: AddressLike],
    [void],
    "nonpayable"
  >;

  initializeFeed: TypedContractMethod<
    [_initOwner: AddressLike, _asset: AddressLike, _description: string],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "initializeARWFeedInfo",
  ): TypedContractMethod<
    [
      _initOwner: AddressLike,
      _asset: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "initializeConsumer",
  ): TypedContractMethod<
    [_initOwner: AddressLike, _router: AddressLike],
    [void],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "InitializedConsumer",
  ): TypedContractEvent<
    InitializedConsumerEvent.InputTuple,
    InitializedConsumerEvent.OutputTuple,
    InitializedConsumerEvent.OutputObject
  >;
  getEvent(
    key: "NewAsset",
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "InitializedConsumer(address)": TypedContractEvent<
      InitializedConsumerEvent.InputTuple,
      InitializedConsumerEvent.OutputTuple,
      InitializedConsumerEvent.OutputObject
    >;
    InitializedConsumer: TypedContractEvent<
      InitializedConsumerEvent.InputTuple,
      InitializedConsumerEvent.OutputTuple,
      InitializedConsumerEvent.OutputObject
    >;
